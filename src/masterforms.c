...
const struct masterform_type masterforms_table[] =
{
	...
	{"{RCrescent Arc{x","AxeMaster attack 2{x", "{REye of the Wolf{x"}, /*AxeMaster 2 */	
	...
	{"{RSpinal Severing{x","AxeMaster attack 5{x", "{RCharging Aurochs{x"}, /*AxeMaster 5 */	
	...
	{"{RSpinning Talons{x","AxeMaster attack 10{x", "{RWrath of the Heavens{x"}, /*AxeMaster 10 */	
	...
	{"{yCrushing Slam{x","Flailmaster attack 4{x", "{yCrushing Swing{x"}, /*Flailmaster 4 */	
	...
	{"{MThe Red Smile{x","Whipmaster attack 12{x", "{MCat of Nine Tails{x"}, /*Whipmaster 12 */	
	...
	{"{YStrike of the Wolverine{x","Staffmaster attack 5{x", "{YThe Old Oak{x"}, /*Staffmaster 5 */	
	...
	{"{YSmile of Death{x","Staffmaster attack 9{x", "{YWillows in the Wind{x"}, /*Staffmaster 9 */	
