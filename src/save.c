...
/* Merits/Flaws/Talents */
	...
	fprintf( fp, "Colourg     %d%d%d %d%d%d %d%d%d\n", 
		    ...
		    ch->pcdata->tguild_talk[2],
		    ch->pcdata->tguild_talk[0],
		    ch->pcdata->tguild_talk[1],
...
*/
	...
	case 'S':
	  ...
	  KEY( "Tguild", ch->tguild, tguild_lookup(fread_string(fp)));
	  KEY( "Trank", ch->tguild_rank, fread_number(fp));	  
	  KEY( "Ttitle", ch->tguild_title, fread_string(fp));
	  KEY( "Tinvis", ch->tguild_invis, fread_number(fp));
