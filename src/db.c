...
void load_tguilds     args ( (void) ); /* tguilds.c */
...
void do_areas( CHAR_DATA *ch, char *argument )
{
  ...
  sprintf(buf, "Open areas at the Shadows of the Wheel:\n\n\r");
  add_buf(output, buf);
...
void do_areas2( CHAR_DATA *ch, char *argument )
{
   ...
   send_to_char("Avaiable areas at the Shadows of the Wheel:\n\n\r", ch );
