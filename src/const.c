 ...
 */
	...
	{
	"blast door",     { 11, 14, 16, 17),      { 1, 1, 2, 2},
	spell_blast_door,      TAR_DEFENSIVE,    POS_STANDING,
	NULL,          SLOT(701),     5, 12,
	"",         "!Door Blast!", ""
	},
	
	{
	"align matrix",  { 9, 53, 53, 53 }, 	{ 1, 1, 2, 2 },
	spell_align_matrix,		TAR_OBJ_INV,		POS_STANDING,
	NULL,			SLOT(702),	60,	24,
	"",			"!Align Matrix!",		""
    },
...
/* non-combat skills */
	...
	{
	"mend",			{ 25, 25, 25, 25 }, { 10, 10, 10, 10},
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_mend,			SLOT{ 0},   50,  12,
	"", 		"!Mend!",			""
	},
