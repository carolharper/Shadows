...
const	struct	cmd_type	cmd_table	[] =
{
	...
	{ "clearcommand",	do_clearcommand,POS_DEAD,	     0,	 LOG_NORMAL, 1 },
...
/*  { "music",			do_music,		POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
	...
	{ "ajahtalk",   	do_ajahtalk, 	POS_SLEEPING,	 0,  LOG_NORMAL, 1 },
 ...
 /* { "brandish",		do_brandish,	POS_RESTING,	 0,  LOG_NORMAL, 1 },*/
	...
	{ "mend",       	do_mend,    	POS_STANDING,    0,  LOG_NORMAL, 1 },
...
void do_commands( CHAR_DATA *ch, char *argument )
{
    ...
    if (!str_cmp(argument,"rp")) {
       send_to_char("The Shadows of the Wheel Roleplay Logged Commands:\n\r", ch);
       ...
       send_to_char("The Shadows of the Wheel Logged Commands:\n\r", ch);
