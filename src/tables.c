...
/* various flag tables - tguild */
const struct flag_type tguild_flags[] =
{
  {  "Independent",	TGUILD_INDEPENDENT, TRUE 	},
  {	"Modified",	TGUILD_CHANGED,	 FALSE	},
  {	"Delete",		TGUILD_DELETED,	 TRUE	},
  {  "Immortal",	TGUILD_IMMORTAL,    TRUE	},
  {	NULL,		0,			      FALSE    }
};
...
const struct flag_type room_flags[] =
{
  ...
  {  "mining_iron",      ROOM_MINING_IRON,       TRUE },  
{	NULL,		0,			     0	}
};
...
const struct flag_type extra_flags[] =
{
	...
	{   "aligned",     ITEM_ALIGNED,        TRUE    },
	{   "guild",		ITEM_GUILD,			TRUE	},
    {	NULL,          0,                   0	   }
};
...
const struct flag_type wear_flags[] =
{
	...
	{	"WTonly",		ITEM_WEAR_WT_ONLY,		TRUE	},
	{	"BTonly",		ITEM_WEAR_BT_ONLY,		TRUE	},
	{	"CotLonly",		ITEM_WEAR_COTL_ONLY,	TRUE	},
	{	"BGonly",		ITEM_WEAR_BG_ONLY,		TRUE	},
...
const struct background_type merit_table[]=
{
  ...
  { "warder"        , MERIT_WARDER        ,   0 , -1             , NULL, "ogier trolloc fade", FALSE },
  { "aessedai"      , MERIT_AESSEDAI      ,   0 , CLASS_CHANNELER, NULL, "ogier trolloc fade aiel seanchan", FALSE },
  { "blueajah"      , MERIT_BLUEAJAH      ,   0 , CLASS_CHANNELER, NULL, "ogier trolloc fade aiel seanchan", FALSE },
  { "yellowajah"    , MERIT_YELLOWAJAH    ,   0 , CLASS_CHANNELER, NULL, "ogier trolloc fade aiel seanchan", FALSE },
  { "redajah"       , MERIT_REDAJAH       ,   0 , CLASS_CHANNELER, NULL, "ogier trolloc fade aiel seanchan", FALSE },
  { "brownajah"     , MERIT_BROWNAJAH     ,   0 , CLASS_CHANNELER, NULL, "ogier trolloc fade aiel seanchan", FALSE },
  { "greenajah"     , MERIT_GREENAJAH     ,   0 , CLASS_CHANNELER, NULL, "ogier trolloc fade aiel seanchan", FALSE },
  { "whiteajah"     , MERIT_WHITEAJAH     ,   0 , CLASS_CHANNELER, NULL, "ogier trolloc fade aiel seanchan", FALSE },
  { "greyajah"      , MERIT_GREYAJAH      ,   0 , CLASS_CHANNELER, NULL, "ogier trolloc fade aiel seanchan", FALSE },
...
const struct background_type flaw_table[]=
{
  ...
  { "short"         , FLAW_SHORT          ,  50 , -1             , NULL, "ogier trolloc", TRUE },
...
const struct background_type talent_table[]=
{
  ...
  { "foretelling"   , TALENT_FORETELLING  , 50 , CLASS_CHANNELER, NULL   , NULL   , FALSE },
  { "healing"       , TALENT_HEALING      , 50 , CLASS_CHANNELER, NULL   , NULL   , TRUE },
  { "illusion"      , TALENT_ILLUSION     , 50 , CLASS_CHANNELER, NULL   , NULL   , TRUE },
  { "keeping"       , TALENT_KEEPING      , 50 , CLASS_CHANNELER, NULL   , NULL   , FALSE },
  ...
  { "traveling"     , TALENT_TRAVELING    , 50 , CLASS_CHANNELER, NULL   , NULL   , TRUE },
