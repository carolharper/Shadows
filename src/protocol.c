...
static variable_name_t VariableNameTable[eMSDP_MAX+1] = 
{
 ...
 //  { eMSDP_ALIGNMENT,        "ALIGNMENT",        NUMBER_READ_ONLY }, 
   ...
   { eMSDP_ENDURANCE,        "ENDURANCE",        NUMBER_READ_ONLY }, 
   { eMSDP_ENDURANCE_MAX,    "ENDURANCE_MAX",    NUMBER_READ_ONLY }, 
...
static void SendMSSP( descriptor_t *apDescriptor )
{
   ...
   static MSSP_t MSSPTable[] =
   {
      ...
      { "CRAWL DELAY",        "-1" },
/*
      { "HOSTNAME",           "ageofillusionmud.com" },
      { "PORT",               "1060" },
      { "CODEBASE",           "Modified ROM 2.4b6" },
      { "CONTACT",            "bryan.hamann@gmail.com" },
      { "CREATED",            "2013" },
      { "ICON",               "" },
      { "IP",                 "" },
      { "LANGUAGE",           "English" },
      ...
      { "MINIMUM AGE",        "0" },
      { "WEBSITE",            "www.ageofillusionmud.com" },
*/
      /* Categorisation */
/*
      { "FAMILY",             "DikuMUD" },
      { "GENRE",              "Fantasy" },
      { "GAMEPLAY",           "Roleplaying,Hack and Slash,Player versus Envrionment" },
      { "STATUS",             "Live" },
      { "GAMESYSTEM",         "None" },
      { "INTERMUD",           "" },
      { "SUBGENRE",           "Wheel of Time" },
*/
      /* World */
/*
      { "AREAS",              "94" },
